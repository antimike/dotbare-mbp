"""
Use FZF for backwards-i-search in iPython
From https://stackoverflow.com/questions/48203949/backward-search-in-ipython-via-fzf
NOTE: pyfzf replaced with iterfzf
"""
...
try:
    ...
    print("iterfzf is not installed")
    exit()
